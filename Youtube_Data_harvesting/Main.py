...
icon = Image.open("C:\\Users\\Admin\\Desktop\\youtube_logo\\yt_logo.jpg")
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing | By Sasikala",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This app is created by *Sasikala!*"""})
...
db = client.Youtube_Data_Sasikala
