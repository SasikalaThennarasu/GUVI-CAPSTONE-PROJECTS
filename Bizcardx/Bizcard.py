...
icon = Image.open("C:\\Users\\Admin\\Desktop\\OIP.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By T.SASIKALA",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *T.SASIKALA*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\Admin\\Desktop\\OIP.jpg"), width=500)
